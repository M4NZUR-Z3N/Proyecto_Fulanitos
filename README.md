...
## Primer avance
1. Definición de la empresa, a continuación se detalla lo mínimo que debe presentar el landing page:
- [x] Nombre
- [x] Logotipo
- [x] Misión
- [x] Visión
...
- [x] Prototipo funcional de la aplicación web de comercio electrónico (mobile o desktop)
